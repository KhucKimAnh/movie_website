    ...
    <div class="grid">
                <nav class="header__navbar">
                    <div class="header-navbar__logo">
                        <a href="trangChu.html" class="header-navbar__logo-link"><img src="./Assets/Image/Logo.PNG"
                ...
                <div class="grid">
                    ...
                    <ul class="header-category__list">
                        <li class="header-category__list-item">
                            <a href="trangChu.html" class="header-category__list-item-link">
                                        ...
                                        <div class="home-movie__item-detail">
                                            ...
                                            <div class="home-movie-item__button">
                                                ...
                                                <div class="home-movie-item__btn-watch-wrap">
                                                    <a href="" class="home-movie-item__btn-watch">
                                                        Xem phim
                                                    </a>
                                                </div>
                                            </div>
